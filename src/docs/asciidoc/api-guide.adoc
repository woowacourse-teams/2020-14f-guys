...
[[resources-get-calculation-fail-rider]]
==== Fail : Forbidden Rider
operation::calculation/get-fail-by-rider-id[snippets='http-request,http-response,path-parameters,request-headers,response-fields']
